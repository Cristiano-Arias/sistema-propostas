...
const Auth = {
    ...
    async login(email, senha) {
        try {
            ...
            if (response.ok && data.success) {
                // O backend retorna access_token e refresh_token
    ...
    // Logout
    async logout() {
        // Revoga o token no backend e remove credenciais locais
        try {
            ...
            console.warn('Erro ao revogar token durante logout:', err);
        } finally {
